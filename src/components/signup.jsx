    ...
    return (
        <div className="   flex h-[var(--custom-height)] items-center justify-center">
          ...
          <div className=" bg-gray-200 w-full max-w-md p-6 rounded-b-3xl flex items-center justify-center opacity-75">
              ...
              <input type="username" className="form-input mt-1 block w-full outline-blue-500 outline-1 focus:outline-green-500 p-2 rounded-lg" id="username" aria-describedby="username" />
            </div>
                <div className="mb-4 ">
